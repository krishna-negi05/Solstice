...
function toProjects() {
  var element = document.getElementById("Celebrations");
  var headerOffset = 85;
  var elementPosition = element.getBoundingClientRect().top;
  var offsetPosition = elementPosition + window.pageYOffset - headerOffset;
...
new Typewriter(".loading-text", {
  strings: ["Preparing for the Solstice... 🌌"],
  autoStart: true,
  delay: 50,
  cursor: "|",
  deleteSpeed: 10,
...
const projectData = [
  {
    ...
    thumbnail: "../img/thumbnails/ireland.webp",
    description:
      "Newgrange -Built over 5,000 years ago, aligns with the winter solstice sunrise, illuminating its inner chamber in a symbolic triumph of light over darkness.",
    srcURL: "https://www.newgrange.com/winter_solstice.htm",
  },
  {
    title: "Inti Raymi - Peru",
    thumbnail: "../img/thumbnails/peru.png",
    description:
      "Inti Raymi, an ancient Incan festival honoring the Sun god Inti, features music, dancing, and sacrifices, showcasing the Sun's role in agricultural societies.",
    srcURL: "https://en.wikipedia.org/wiki/Inti_Raymi",
  },
  {
    title: "Modranicht - Anglo-Saxon Tradition",
    subTitle: "Web based terminal emulator",
    thumbnail: "../img/thumbnails/anglo.jpg",
    description:
      "Modranicht, meaning Mother's Night, was an Anglo-Saxon solstice tradition honoring female deities and ancestral mothers, symbolizing fertility and the Sun's rebirth.",
    srcURL: "https://en.wikipedia.org/wiki/M%C5%8Ddraniht",
  },
  {
    title: "Koliada - Eastern Europe",
    subTitle:
      "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima nobis quia et.",
    thumbnail: "../img/thumbnails/koleda.jpg",
    description:
      "Koliada, a Slavic winter solstice festival, features caroling, feasting, and fire rituals to celebrate the Sun's return and has influenced modern Christmas and New Year traditions.",
    srcURL: "https://www.czechcenter.org/blog/2020/12/21/koleda-winter-solstice-festival",
  },
    ...
    elem.innerHTML = buildTemplate(
      `<div class='Celebrations-header'>
       ...
       <div class="card-buttons">
          <a href="{srcURL}" target="_blank" class="card-btn" style="float: right; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-solid fa-display"></i>Source</a>
      </div>`,
      data
    );
    setTimeout(() => {
